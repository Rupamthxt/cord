...
from backend.entities.models import ChunkEntityRef, Entity
...
class EntityStore:
    """Async CRUD + dedup-aware store for :class:`~backend.entities.models.Entity`.
    ...
    async def create(
        ...
        Args:
            session: Active async DB session.
            payload: Validated :class:`~backend.entities.schema.EntityCreate`.
