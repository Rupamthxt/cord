...
:class:`~backend.graph.entities.store.EntityStore`.
"""
...
from backend.graph.entities.store import EntityStore, entity_store
...
class EntityDeduplicator:
    ...
    Attributes:
        store: The :class:`~backend.graph.entities.store.EntityStore` singleton used
               for all DB queries.
    ...
    async def resolve(
        ...
        Returns:
            The matched :class:`~backend.graph.entities.models.Entity` ORM instance,
